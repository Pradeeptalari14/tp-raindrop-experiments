...
> A/B testing integration configurations managing model variants, system prompt updates, and PostHog logs.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-raindrop-experiments.git
cd tp-raindrop-experiments
```
...
```bash
kubectl port-forward deployment/tp-raindrop-experiments 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── posthog_config.json     # Main configuration file
```
...
---
*Generated by [Raindrop Experiments Studio](https://pradeeptalari14.github.io/portfolio/tools/raindrop-experiments/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
